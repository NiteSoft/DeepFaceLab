...
class SAEModel(ModelBase):
    ...
    def onInitialize(self):
        ...
        if self.is_training_mode:
            self.src_dst_opt      = Adam(lr=5e-5, beta_1=0.5, beta_2=0.8, clipnorm=1.0, tf_cpu_mode=self.options['optimizer_mode']-1)
            self.src_dst_mask_opt = Adam(lr=5e-5, beta_1=0.5, beta_2=0.8, clipnorm=1.0, tf_cpu_mode=self.options['optimizer_mode']-1)
